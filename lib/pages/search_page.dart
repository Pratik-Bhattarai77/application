...
// SearchPage widget which allows users to search and view books
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        // Stream to get the list of books from Firestore
                ...
                child: Card(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          // Display book image using CachedNetworkImage
                          CachedNetworkImage(
                            imageUrl: data['image'] ?? '',
